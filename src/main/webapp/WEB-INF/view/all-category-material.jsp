...
<html>
<body>
<h2>Справочник материала игрушеки</h2>
<br>
<table>
    <tr>
        <th>ID </th>
    ...
    <c:forEach var="сategory" items="${categorys}" >
        <c:url var="updateButton" value="/updateMaterialToy">
            <c:param name="categoryId" value="${сategory.id}"></c:param>
        </c:url>
        <c:url var="deleteBatton" value="/deleteMaterialToy">
            <c:param name="categoryId" value="${сategory.id}"></c:param>
        </c:url>
        <tr>
    ...
    <input type="button" value="Add" onclick="window.location.href='addNewMaterialToy'"/>
